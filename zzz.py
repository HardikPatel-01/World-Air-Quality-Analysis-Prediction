...
# Load dataset - Make sure world_air_quality_file.csv is in the same folder as this script
csv_file = "world_air_quality_file.csv"
...
def get_aqi_category(pollutant, value):
    ...
    elif pollutant in ["BC", "TEMPERATURE", "UM003", "RELATIVE HUMIDITY"]:
...
print("✅ AQI categories added for all rows and saved as new_dataset.csv")
